...
try {
var zahirr = db.get("nurul");
} catch (e) {
	console.log('')
}

var creatorList = ['@thenay_xploit_','@tnfajri_003'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat aku aja yaaa di wa.me/6283815956151 , key nya gratis kok kak, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat aku aja yaaa di wa.me/6283815956151 , key nya gratis kok kak, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------NurulCans'+'NURUL--CANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'NurulCans') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
...
router.get('/randomquote', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-nurul.herokuapp.com/api/random/quotes`))
...
router.get('/hadits', async (req, res, next) => {
    ...
    if (!nomor) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter nomor"})
       ...
       fetch(encodeURI(`https://hadits-api-nurul.vercel.app/books/${kitab}/${nomor}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fbdown', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://fb-api-nurul.vercel.app/?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/tahlil', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/dataTahlil.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/wirid', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/dataWirid.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/ayatkursi', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/dataAyatKursi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/doaharian', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/dataDoaHarian.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/bacaanshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/dataBacaanShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/dataNiatShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/kisahnabi', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/dataKisahNabi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/dataAsmaulHusna.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshubuh', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/NiatShubuh.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatdzuhur', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/NiatDzuhur.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatmaghrib', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/NiatMaghrib.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatisya', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/NiatIsya.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatashar', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/data/NiatAshar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/cyberspace', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/CyberSpace.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/teknologi', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/Technology.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/Islamic.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/programming', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/Programming.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/pegunungan', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/My-SQL-Results/main/Mountain.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wikipedia', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/wiki?keyword=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/randomquote/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/quote?type=agamis`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/drakorasia', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`http://docs-api-nurul.herokuapp.com/api/drakorasia?search=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/jadwalshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/alonecans/Nurul-Database/main/adzan/${kota}/2021/03.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fakedata', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://fakename-api-nurul.vercel.app/api/fakename?country=${country}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilih', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://hilih-api-nurul.vercel.app/api/hilih?kata=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/liriklagu', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-nurul.herokuapp.com/api/lirik?search=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/chordlagu', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-nurul.herokuapp.com/api/chord?q=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-nurul.herokuapp.com/api/random/asmaulhusna`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kbbi', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://kbbi-api-nurul.vercel.app/api/kbbi?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covidindo', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://covid19-api-nurul.vercel.app/api/covid-indonesia`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covidworld', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://covid19-api-nurul.vercel.app/api/world`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kodepos', async (req, res, next) => {
	...
	if(!kota) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kota"})
       ...
       fetch(encodeURI(`https://kodepos-api-nurul.vercel.app/?q=${kota}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/cuaca', async (req, res, next) => {
	...
	if(!kabupaten) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kabupaten"})
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/cuaca?kabupaten=${kabupaten}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/meme', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/meme`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/quotes/kanye', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/quote?type=kanye`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/translate', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
	if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/translate?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/anime/kusonime', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/kusonime?search=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/gabut', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/bosan`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/manga', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/manga?keyword=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/wallpaper', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/random/wallpaper?genre=acak`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kuis/caklontong', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/quote?type=caklontong`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kuis/tebakgambar', async (req, res, next) => {
	...
	if(apikeyInput != 'NurulCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-nurul.herokuapp.com/api/quote?type=tebakgambar`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
